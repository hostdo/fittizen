...
<?php
echo JText::_('COM_FITTIZEN_GYMS');
?>
</h3>
<ul id="toolbar" class="toolbar-list">
    <li>
        <a href="./index.php?option=com_fittizen&view=gyms&layout=edit" class="btn btn-small">
            <span class="icon-new"></span>
...
<div id="list-container" class="span9">
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr class="row<?php echo ($row_index%2) ?>">
                ...
                <td>
                    <form action="./index.php?option=com_fittizen&view=gyms&layout=edit" method="POST">
                    ...
                    <a class="btn btn-small" href="./index.php?option=com_fittizen&view=gyms&mode=delete&id=<?php echo $obj->id; ?>">
    ...
    <?php echo HtmlGenerator::GeneratePagination($tmp->getObjectName(),
            './index.php?option=com_fittizen&view=gyms', $total, 
            $limitstart, 
