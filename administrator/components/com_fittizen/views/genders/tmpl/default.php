...
<?php
echo JText::_('COM_FITTIZEN_GENDERS');
?>
</h3>
<ul id="toolbar" class="toolbar-list">
    <li>
        <a href="./index.php?option=com_fittizen&view=genders&layout=edit" class="btn btn-small">
...
<div id="list-container" class="span9">
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr class="row<?php echo ($row_index%2) ?>">
                ...
                <td>
                    <form action="./index.php?option=com_fittizen&view=genders&layout=edit" method="POST">
    ...
    <?php echo HtmlGenerator::GeneratePagination($tmp->getObjectName(),
            './index.php?option=com_fittizen&view=genders', $total, 
            $limitstart, 
