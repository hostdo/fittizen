 ...
 * View
 */
class FittizenViewFittizens extends JViewLegacy
{
        /**
         *  view display method
         * @return void
        ...
        public function save()
        {
            ...
            $obj = new bll_fitinfos($id);
            $profile_code=filter_input(INPUT_POST, 'profile_code');
            if($obj->profile_code != $profile_code && $profile_code != "")
            {
                if(!bll_fitinfos::check_profile_code($profile_code))
                {
                    $_POST['profile_code']=$obj->profile_code;
                }
            }
