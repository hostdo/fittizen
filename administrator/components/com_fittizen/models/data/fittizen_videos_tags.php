...
/**
 * Instance of D.B. table fittizen_videos_tags this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_videos_tags extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_videos_tags dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_videos_tags Not false on success.
     */
     ...
     *
     * @return fittizen_videos_tags not false on success.
     */
