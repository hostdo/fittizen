...
/**
 * Instance of D.B. table fittizen_banner_filter this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_banner_filter extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_banner_filter dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_banner_filter Not false on success.
     */
