...
/**
 * Instance of D.B. table fittizen_comment_video this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_comment_video extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_comment_video dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_comment_video Not false on success.
     */
     ...
     *
     * @return fittizen_comment_video not false on success.
     */
