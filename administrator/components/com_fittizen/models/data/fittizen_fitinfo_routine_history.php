...
/**
 * Instance of D.B. table fittizen_fitinfo_routine_history this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fitinfo_routine_history extends dbobject {
     
    public $id="";
    public $fitinfo_routine_days_id="";
    public $achieved="";
    public $trainer_id="";
    public $created_date="";
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfo_routine_history dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfo_routine_history Not false on success.
     */
     ...
     *
     * @return fittizen_fitinfo_routine_history not false on success.
     */
