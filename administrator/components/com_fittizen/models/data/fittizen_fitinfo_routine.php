...
/**
 * Instance of D.B. table fittizen_fitinfo_routine this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fitinfo_routine extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfo_routine dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfo_routine Not false on success.
     */
     ...
     *
     * @return fittizen_fitinfo_routine not false on success.
     */
