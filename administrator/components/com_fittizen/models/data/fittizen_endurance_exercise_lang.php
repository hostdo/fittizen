...
/**
 * Instance of D.B. table fittizen_endurance_exercise_lang this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_endurance_exercise_lang extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_endurance_exercise_lang dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_endurance_exercise_lang Not false on success.
     */
     ...
     *
     * @return fittizen_endurance_exercise_lang not false on success.
     */
