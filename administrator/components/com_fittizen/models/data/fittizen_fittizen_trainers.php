...
/**
 * Instance of D.B. table fittizen_fittizen_trainers this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fittizen_trainers extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fittizen_trainers dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fittizen_trainers Not false on success.
     */
     ...
     *
     * @return fittizen_fittizen_trainers not false on success.
     */
