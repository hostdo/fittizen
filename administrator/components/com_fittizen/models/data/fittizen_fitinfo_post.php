...
/**
 * Instance of D.B. table fittizen_fitinfo_post this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fitinfo_post extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfo_post dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfo_post Not false on success.
     */
     ...
     *
     * @return fittizen_fitinfo_post not false on success.
     */
