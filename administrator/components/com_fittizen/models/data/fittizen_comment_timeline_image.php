...
/**
 * Instance of D.B. table fittizen_comment_timeline_image this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_comment_timeline_image extends dbobject {
     
    public $id="";
    public $timeline_image_id="";
    public $fitinfo_id="";
    public $message="";
    public $created_date="";
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_comment_timeline_image dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_comment_timeline_image Not false on success.
     */
     ...
     *
     * @return fittizen_comment_timeline_image not false on success.
     */
