...
/**
 * Instance of D.B. table fittizen_chest_history this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_chest_history extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_chest_history dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_chest_history Not false on success.
     */
     ...
     *
     * @return fittizen_chest_history not false on success.
     */
