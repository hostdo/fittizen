...
class fittizen_gyms extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_gyms dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_gyms Not false on success.
     */
     ...
     *
     * @return fittizen_gyms not false on success.
     */
