...
/**
 * Instance of D.B. table fittizen_supplements this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_supplements extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_supplements dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_supplements Not false on success.
     */
     ...
     *
     * @return fittizen_supplements not false on success.
     */
