...
class fittizen_album extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_album dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_album Not false on success.
     */
     ...
     *
     * @return fittizen_album not false on success.
     */
