...
class fittizen_post extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_post dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_post Not false on success.
     */
     ...
     *
     * @return fittizen_post not false on success.
     */
