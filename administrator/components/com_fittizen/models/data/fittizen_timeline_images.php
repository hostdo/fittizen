...
/**
 * Instance of D.B. table fittizen_timeline_images this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_timeline_images extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_timeline_images dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_timeline_images Not false on success.
     */
     ...
     *
     * @return fittizen_timeline_images not false on success.
     */
