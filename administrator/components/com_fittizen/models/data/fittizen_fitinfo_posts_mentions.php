...
/**
 * Instance of D.B. table fittizen_fitinfo_posts_mentions this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fitinfo_posts_mentions extends dbobject {
     
    public $id="";
    public $fitinfo_post_id="";
    public $fitinfo_id="";
    public $created_date="";
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfo_posts_mentions dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfo_posts_mentions Not false on success.
     */
     ...
     *
     * @return fittizen_fitinfo_posts_mentions not false on success.
     */
