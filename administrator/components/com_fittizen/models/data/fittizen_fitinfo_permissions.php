...
/**
 * Instance of D.B. table fittizen_fitinfo_permissions this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fitinfo_permissions extends dbobject {
    ...
    public $waist_history="";
    public $hip_history="";
    public $neck_history="";
    public $chest_history="";
    public $upper_arm_history="";
    public $thigh_history="";
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfo_permissions dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfo_permissions Not false on success.
     */
     ...
     *
     * @return fittizen_fitinfo_permissions not false on success.
     */
