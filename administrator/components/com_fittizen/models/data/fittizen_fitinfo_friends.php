...
/**
 * Instance of D.B. table fittizen_fitinfo_friends this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fitinfo_friends extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfo_friends dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfo_friends Not false on success.
     */
