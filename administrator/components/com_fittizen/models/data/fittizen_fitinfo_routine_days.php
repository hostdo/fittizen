...
/**
 * Instance of D.B. table fittizen_fitinfo_routine_days this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fitinfo_routine_days extends dbobject {
     
    public $id="";
    public $fitinfo_routine_id="";
    public $day="";
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfo_routine_days dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfo_routine_days Not false on success.
     */
     ...
     *
     * @return fittizen_fitinfo_routine_days not false on success.
     */
