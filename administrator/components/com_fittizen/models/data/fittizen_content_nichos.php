...
/**
 * Instance of D.B. table fittizen_content_nichos this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_content_nichos extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_content_nichos dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_content_nichos Not false on success.
     */
