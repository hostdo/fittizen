...
/**
 * Instance of D.B. table fittizen_nichos_lang this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_nichos_lang extends dbobject {
    ...
    */
     ...
     *
     * @return boolean|fittizen_nichos_lang Not false on success.
     */
     ...
     *
     * @return fittizen_nichos_lang not false on success.
     */
