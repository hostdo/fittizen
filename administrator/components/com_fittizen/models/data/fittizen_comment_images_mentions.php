...
/**
 * Instance of D.B. table fittizen_comment_images_mentions this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_comment_images_mentions extends dbobject {
     
    public $id="";
    public $comment_image_id="";
    public $fitinfo_id="";
    public $created_date="";
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_comment_images_mentions dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_comment_images_mentions Not false on success.
     */
     ...
     *
     * @return fittizen_comment_images_mentions not false on success.
     */
