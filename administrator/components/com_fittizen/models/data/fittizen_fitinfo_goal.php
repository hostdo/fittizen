...
/**
 * Instance of D.B. table fittizen_fitinfo_goal this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fitinfo_goal extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfo_goal dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfo_goal Not false on success.
     */
     ...
     *
     * @return fittizen_fitinfo_goal not false on success.
     */
