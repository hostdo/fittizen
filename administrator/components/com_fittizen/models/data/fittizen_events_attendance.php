...
/**
 * Instance of D.B. table fittizen_events_attendance this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_events_attendance extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_events_attendance dbobject or false on failure.
     */
     ...
     *
     * @return fittizen_events_attendance not false on success.
     */
