...
/**
 * Instance of D.B. table fittizen_banner_locations this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_banner_locations extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_banner_locations dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_banner_locations Not false on success.
     */
