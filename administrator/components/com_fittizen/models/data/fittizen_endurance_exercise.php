...
/**
 * Instance of D.B. table fittizen_endurance_exercise this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_endurance_exercise extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_endurance_exercise dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_endurance_exercise Not false on success.
     */
     ...
     *
     * @return fittizen_endurance_exercise not false on success.
     */
