...
/**
 * Instance of D.B. table fittizen_timeline_images_tags this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_timeline_images_tags extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_timeline_images_tags dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_timeline_images_tags Not false on success.
     */
     ...
     *
     * @return fittizen_timeline_images_tags not false on success.
     */
