...
/**
 * Instance of D.B. table fittizen_upper_arm_history this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_upper_arm_history extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_upper_arm_history dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_upper_arm_history Not false on success.
     */
     ...
     *
     * @return fittizen_upper_arm_history not false on success.
     */
