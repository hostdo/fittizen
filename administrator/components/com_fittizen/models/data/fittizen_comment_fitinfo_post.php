...
/**
 * Instance of D.B. table fittizen_comment_fitinfo_post this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_comment_fitinfo_post extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_comment_fitinfo_post dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_comment_fitinfo_post Not false on success.
     */
     ...
     *
     * @return fittizen_comment_fitinfo_post not false on success.
     */
