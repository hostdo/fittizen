...
/**
 * Instance of D.B. table fittizen_comment_image this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_comment_image extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_comment_image dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_comment_image Not false on success.
     */
     ...
     *
     * @return fittizen_comment_image not false on success.
     */
