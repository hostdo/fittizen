...
/**
 * Instance of D.B. table fittizen_fitinfo_gym this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fitinfo_gym extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfo_gym dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfo_gym Not false on success.
     */
     ...
     *
     * @return fittizen_fitinfo_gym not false on success.
     */
