...
/**
 * Instance of D.B. table fittizen_fittizen_trainers_nichos this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_fittizen_trainers_nichos extends dbobject {
     
    public $id="";
    public $fittizen_trainers_id="";
    public $nicho_id="";
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fittizen_trainers_nichos dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fittizen_trainers_nichos Not false on success.
     */
     ...
     *
     * @return fittizen_fittizen_trainers_nichos not false on success.
     */
