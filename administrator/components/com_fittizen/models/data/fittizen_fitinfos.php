...
class fittizen_fitinfos extends dbobject {
    ...
    public $last_notification_check="";
    public $fb_id="";
    public $gplus_id="";
    public $twitter_id="";
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_fitinfos dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_fitinfos Not false on success.
     */
     ...
     *
     * @return fittizen_fitinfos not false on success.
     */
