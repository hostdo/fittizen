...
/**
 * Instance of D.B. table fittizen_supplements_lang this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class fittizen_supplements_lang extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_supplements_lang dbobject or false on failure.
     */
     ...
     *
     * @return boolean|fittizen_supplements_lang Not false on success.
     */
     ...
     *
     * @return fittizen_supplements_lang not false on success.
     */
