...
class bll_gyms extends fittizen_gyms
{
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return bll_gyms dbobject or false on failure.
     */
     ...
     *
     * @return boolean|bll_gyms Not false on success.
     */
     ...
     * 
     * @return bll_gyms not false on success.
     */
    ...
    private function addLangValue($id)
    {
        ...
        //deleting old values
        $ofl=new fittizen_gyms_lang(0);
        $ofl->delete('gym_id',$id);
        //adding lang values
        foreach($langs as $lang)
        {
            $lang_suffix = "_".$lang->lang_id;
            $lv = new fittizen_gyms_lang(0);
            $lv->gym_id = $oid;
     ...
     * @return fittizen_gyms_lang catalogcategorylang value object.
     */
    public function getLanguageValue($lang_id)
    {
        ...
        {
            return new fittizen_gyms_lang(-1);
        }
        $langval  = new fittizen_gyms_lang(-1);
        return $langval->find(
                              array(
                                  array('gym_id','='),
                                  array('lang_id','=')
     ...
     * @return fittizen_gyms_lang array of catalogcategorylang value object.
     */
    ...
    /**
     * Gets all the fitinfo related to the gym
     * 
    ...
    {
        $bl = new fittizen_fitinfo_gym(-1);
        return self::convertListToArray(
                $bl->findAll('gym_id', $this->id, 
                        $DESC, $order_field, 
