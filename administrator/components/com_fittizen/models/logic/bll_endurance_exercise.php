<?php
/**
 * Logic layer object of D.B. table fittizen_endurance_exercise this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class bll_endurance_exercise extends fittizen_endurance_exercise
{
   /**
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return bll_endurance_exercise dbobject or false on failure.
     */
     ...
     *
     * @return boolean|bll_endurance_exercise Not false on success.
     */
     ...
     *
     * @return bll_endurance_exercise not false on success.
     */
    ...
    private function addLangValue($id)
    {
        ...
        //deleting old values
        $ofl=new fittizen_endurance_exercise_lang(0);
        $ofl->delete('endurance_exercise_id',$id);
        //adding lang values
        foreach($langs as $lang)
        {
            $lang_suffix = "_".$lang->lang_id;
            $lv = new fittizen_endurance_exercise_lang(0);
            $lv->endurance_exercise_id = $oid;
     ...
     * @return fittizen_endurance_exercise_lang catalogcategorylang value object.
     */
    public function getLanguageValue($lang_id)
    {
        ...
        {
            return new fittizen_endurance_exercise_lang(-1);
        }
        $langval  = new fittizen_endurance_exercise_lang(-1);
        return $langval->find(
                              array(
     ...
     * @return fittizen_endurance_exercise_lang array of catalogcategorylang value object.
     */
    ...
    /**
     * Gets all the fitinfo related to the endurance_exercise
    ...
    {
        $bl = new fittizen_fitinfo_endurance_exercise(-1);
        return self::convertListToArray(
                $bl->findAll('endurance_exercise_id', $this->id, 
                        $DESC, $order_field, 
