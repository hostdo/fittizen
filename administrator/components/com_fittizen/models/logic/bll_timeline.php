<?php
/**
 * Logic layer object of D.B. table fittizen_timeline this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class bll_timeline extends fittizen_timeline
{
   /**
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return bll_timeline dbobject or false on failure.
     */
     ...
     *
     * @return boolean|bll_timeline Not false on success.
     */
     ...
     *
     * @return bll_timeline not false on success.
     */
    ...
    /**
     * Gets all the timeline from a timeline
     * 
    ...
    {
        return bll_timeline_images::getImages($this->id,$DESC, 
     ...
     * @return bll_timeline dbobject or false on failure.
     */
    public static function getTimelines($fitinfo_id,
            $DESC=true,$order_field='created_date',
            $lower_limit=null, $upper_limit=null)
    {
        $image = new bll_timeline(-1);
