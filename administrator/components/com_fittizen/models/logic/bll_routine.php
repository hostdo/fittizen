<?php
/**
 * Logic layer object of D.B. table fittizen_routine this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class bll_routine extends fittizen_routine
{
   /**
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return bll_routine dbobject or false on failure.
     */
     ...
     *
     * @return boolean|bll_routine Not false on success.
     */
     ...
     *
     * @param int $trainer_id trainer id if the routine is created by a trainer.
     * 
     * @return bll_routine not false on success.
     */
    public function insert($trainer_id=null) 
    {
     ...
     * 
     * @return bll_routines not false on success. 
     */
    ...
    private function addLangValue($id)
    {
        ...
        //deleting old values
        $ofl=new fittizen_routine_lang(0);
        $ofl->delete('routine_id',$id);
        //adding lang values
        foreach($langs as $lang)
        {
            $lang_suffix = "_".$lang->lang_id;
            $lv = new fittizen_routine_lang(0);
            $lv->routine_id = $oid;
     ...
     * @return fittizen_routine_lang catalogcategorylang value object.
     */
    public function getLanguageValue($lang_id)
    {
        ...
        {
            return new fittizen_routine_lang(-1);
        }
        $langval  = new fittizen_routine_lang(-1);
        return $langval->find(
                              array(
                                  array('routine_id','='),
                                  array('lang_id','=')
     ...
     * @return fittizen_routine_lang array of catalogcategorylang value object.
     */
    ...
    /**
     * Gets all the fitinfo related to the routine
     *
    ...
    {
        $bl = new fittizen_fitinfo_routine(-1);
        return self::convertListToArray(
                $bl->findAll('routine_id', $this->id, 
                        $DESC, $order_field, 
