<?php
/**
 * Logic layer object of D.B. table fittizen_supplements this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class bll_supplements extends fittizen_supplements
{
   /**
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return bll_supplements dbobject or false on failure.
     */
     ...
     *
     * @return boolean|bll_supplements Not false on success.
     */
     ...
     *
     * @return bll_supplements not false on success.
     */
    ...
    private function addLangValue($id)
    {
        ...
        //deleting old values
        $ofl=new fittizen_supplements_lang(0);
        $ofl->delete('supplement_id',$id);
        //adding lang values
        foreach($langs as $lang)
        {
            $lang_suffix = "_".$lang->lang_id;
            $lv = new fittizen_supplements_lang(0);
            $lv->supplement_id = $oid;
     ...
     * @return fittizen_supplements_lang catalogcategorylang value object.
     */
    public function getLanguageValue($lang_id)
    {
        ...
        {
            return new fittizen_supplements_lang(-1);
        }
        $langval  = new fittizen_supplements_lang(-1);
        return $langval->find(
                              array(
                                  array('supplement_id','='),
                                  array('lang_id','=')
     ...
     * @return fittizen_supplements_lang array of catalogcategorylang value object.
     */
    ...
    /**
     * Gets all the fitinfo related to the supplement
     * 
    ...
    {
        $bl = new fittizen_fitinfo_supplement(-1);
        return self::convertListToArray(
                $bl->findAll('supplement_id', $this->id, 
                        $DESC, $order_field, 
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return fittizen_supplements_lang array of language values
     */
    public function checkIncomplete($DESC = true, $order_field = "id", 
            $lower_limit = null, $upper_limit = null)
    {
        $lval = new fittizen_supplements_lang(-1);
        $field = array(
            array('description', '='),
            array('url', '=')
        );
